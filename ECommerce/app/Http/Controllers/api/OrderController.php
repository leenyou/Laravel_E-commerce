...
class OrderController extends Controller
{
    public function confirm_order()
    {
        ...
        if (!empty($unavailable_items)) {
            return response()->json([
                'status' => 0,
                'message' => 'your order is confirmed without this product : ' . implode($unavailable_items) . ' not available in sufficient quantity, you can check another color or another size ',
